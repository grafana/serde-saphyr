...
pub struct SerializerOptions {
    ...
    /// Threshold for scientific notation serialization.
    ///
    ...
    ///
    /// When set to `None`, scientific notation is disabled and numbers are always
    /// serialized in plain decimal notation. This can be useful when the output needs
    /// to be consumed by parsers that don't handle scientific notation well.
    ///
